...
class TelaInicialFragment : Fragment(R.layout.fragment_tela_inicial), MessageInterface {
    ...
    private fun initView() {
        googleBtn = requireView().findViewById(R.id.logoGmail)
        btnCriarContaInicial = requireView().findViewById(R.id.btnCriarContaInicial)
        btnLogarInicial = requireView().findViewById(R.id.btnLogarInicial)
    }
